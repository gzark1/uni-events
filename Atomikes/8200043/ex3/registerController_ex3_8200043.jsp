...
<body>
		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="index_ex3_8200043.jsp">Home</a></li>
					<li class="active"><a href="register_ex3_8200043.jsp">Register</a></li>
	...
	%>
					...
					<a href="register_ex3_8200043.jsp" class="btn btn-info" role="button"><span
