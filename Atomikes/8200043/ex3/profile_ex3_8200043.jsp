	...
	<body>
		...
		<div class="container theme-showcase" role="main">
            ...
            try{
                ...
                userprof = userdao.findUser(request.getParameter("uname"));
			...
			<div class="page-header">
				<h1>Profile of: <code><%=userprof.getFirstname()%> <%=userprof.getLastname()%></code></h1>
			</div>

            <ul class="list-unstyled">
                <li><b>First Name: </b><%=userprof.getFirstname()%></li>
                <li><b>Last Name: </b><%=userprof.getLastname()%></li>
                <li><b>Email: </b><%=userprof.getEmail()%></li>
                <li><b>Username: </b><%=userprof.getUsername()%></li>
            </ul>
            <%
            }else{
