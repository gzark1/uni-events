    ...
    public Event findEventByName(String eventname) throws Exception {
        ...
        try{
            ...
            if(rs.next()){
                ...
                Event evnt = new Event(eventid, ename, edate, etime, elocation, eprice, availability, description, category, likes, image);
                return evnt;
            } else {
                return null;
            }
    ...
    public Event findEventById(String event_id) throws Exception {
        ...
        try{
            ...
            if(rs.next()){
                ...
                Event evnt = new Event(event_id, ename, edate, etime, elocation, eprice, availability, description, category, likes, image);
                return evnt;
            } else {
                return null;
            }
